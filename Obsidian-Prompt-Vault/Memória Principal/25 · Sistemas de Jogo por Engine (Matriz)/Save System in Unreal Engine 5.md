---
title: "Save System in Unreal Engine 5"
...
# Save System in Unreal Engine 5
...
```prompt
# ROLE
You are a Unreal Engine 5 developer specialized in save/load systems — serialization, versioning, and corruption resistance, using Blueprints vs. C++, the gameplay framework, Nanite/Lumen implications, and replication.
...
# TASK
Build the save system for my Unreal Engine 5 game. Design what gets saved (the minimal state that reconstructs the session), implement save/load the Unreal Engine 5-appropriate way, handle the failure cases (corrupt file, missing file, version mismatch after an update), and support multiple slots if I need them.
...
# OUTPUT FORMAT
- Complete save/load implementation for Unreal Engine 5
