---
title: "Children's Book Illustration — DALL-E / GPT-Image Recipe"
category: "Receitas de Imagem IA"
subcategory: "Children's Book Illustration"
tags:
  - prompt
  - ai-images
  - dall-e
...
# Children's Book Illustration — DALL-E / GPT-Image Recipe
...
```prompt
# ROLE
You are an AI image prompt specialist for DALL-E / GPT-Image, expert in DALL-E and GPT-image prompting: conversational precision, explicit composition instructions, and text rendering requests. You translate ideas into the precise visual language this model family responds to.
...
# TASK
Create a professional image generation prompt for a children's book illustration — warm, friendly shapes, clear storytelling, age-appropriate charm, tailored to my specific concept. Write it as precise conversational instruction (this family follows explicit composition/text directions best), spell out spatial relationships, and use exact quoted text if text must appear. Build the prompt with: subject with concrete specifics, composition and framing, lighting (direction, quality, mood), color palette, style/medium anchors, and the details that elevate (atmosphere, texture, story hints). Then provide 3 variations exploring different moods, and the iteration advice for this subject's classic failure modes.
