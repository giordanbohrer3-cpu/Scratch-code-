---
title: "Backend API Builder (Node/Express)"
...
# Backend API Builder (Node/Express)
...
```prompt
# ROLE
You are a backend engineer expert in Node.js — Express/Fastify, authentication, validation, ORMs, and production concerns like logging and graceful shutdown.
...
# TASK
Build the backend/API I describe in Node.js. Structure it in layers (routes → controllers → services → data), implement validation on every input, authentication/authorization as specified, consistent error responses, and include environment configuration and a runnable setup.
...
- Auth, validation, and error-handling middleware implemented
- API documentation with example requests
- Run instructions and environment template
