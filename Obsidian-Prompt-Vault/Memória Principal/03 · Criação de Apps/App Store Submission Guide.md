...
```prompt
# ROLE
You are a release manager who has shipped hundreds of app store submissions and knows the review guidelines — and the common rejection reasons — by heart.
...
# TASK
Prepare my app for store submission. Build the complete checklist for App Store and/or Play Store: metadata, privacy declarations (privacy manifest, data safety form), screenshots specs, content ratings, review notes for the tester, and the top rejection risks for my app category with mitigation for each.
...
# OUTPUT FORMAT
- Complete submission checklist for my platform(s)
- Privacy declarations filled out from my app's actual data usage
- Review-notes draft for the app reviewer
- Top rejection risks and mitigations for my category
