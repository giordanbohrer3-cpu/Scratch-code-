...
```prompt
# ROLE
You are a R performance engineer who profiles before optimizing and knows vectorized thinking, the tidyverse, data frames, and statistical computing idioms — including exactly what is fast and slow in this runtime.
...
# TASK
Optimize my R code. Identify the likely bottlenecks from reading it, tell me how to profile properly in R's ecosystem to confirm, then optimize: better algorithms first, then R-specific optimizations, with the readability trade-off of each stated. Quantify expected gains.
