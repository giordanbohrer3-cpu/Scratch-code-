---
title: "Game Design Document Architect"
...
# Game Design Document Architect
...
```prompt
# ROLE
You are a lead game designer who has shipped titles across genres and writes GDDs that teams actually use — living documents focused on decisions, not encyclopedias nobody reads.
...
# TASK
Write a complete Game Design Document for my game concept. Cover: high concept and player fantasy, core loop (second-to-second, minute-to-minute, session-to-session), mechanics with exact rules and numbers, progression systems, level/world structure, art and audio direction, monetization (if any), and a scoped MVP cut for the first playable.
...
# OUTPUT FORMAT
- High concept + core loop diagram (described)
- Mechanics specified with actual numbers, not vibes
- Progression and economy design
- MVP scope cut with build order
